...
import io.github.otcdlink.chiron.upend.http.dispatch.HttpDispatcherFixture.SecondDuty;
import io.github.otcdlink.chiron.upend.http.dispatch.HttpDispatcherFixture.TransientCommandOne;
import io.github.otcdlink.chiron.upend.http.dispatch.HttpDispatcherFixture.TransientCommandTwo;
...
import static io.github.otcdlink.chiron.upend.http.dispatch.HttpDispatcherFixture.BOOBYTRAPPED_RESOLVER;
import static io.github.otcdlink.chiron.upend.http.dispatch.HttpDispatcherFixture.NULL_RESOLVER;
import static io.github.otcdlink.chiron.upend.http.dispatch.HttpDispatcherFixture.alwaysResolveTo;
...
public class BareHttpDispatcherTest {
  ...
  /**
   * @deprecated {@link io.github.otcdlink.chiron.upend.http.dispatch.HttpResponder.Resolver} is
   *     deprecated.
   */
  @Test
  ...
  public void freeze(
    ...
    final BareHttpDispatcher< ?, ?, Void, Void, ? > conditionBegun =
        newDispatcher().beginCondition( ALWAYS ) ;
