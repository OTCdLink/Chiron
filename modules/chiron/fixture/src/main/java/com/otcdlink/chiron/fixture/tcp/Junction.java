...
import com.otcdlink.chiron.toolbox.ImmutableCollectionTools;
...
//    logger.debug( "Reached Ingress exit: " + transferAtIngressExit + "." ) ;
  ...
  public Junction addIngressConfiguration(
    ...
    channelPipeline.addFirst( TcpTransitTools.ChannelHandlerName.INGRESS_ENTRY.handlerName(), new ChannelInboundHandlerAdapter() {
      @Override
    ...
    channelPipeline.addLast( TcpTransitTools.ChannelHandlerName.INGRESS_EXIT.handlerName(), new ChannelInboundHandlerAdapter() {
      @Override
      public void channelRead(
          final ChannelHandlerContext channelHandlerContext,
          final Object message
  ...
  public Junction addEgressConfiguration(
    ...
    channelPipeline.addFirst( TcpTransitTools.ChannelHandlerName.EGRESS_EXIT.handlerName(), new ChannelOutboundHandlerAdapter() {
      @Override
      public void write(
          final ChannelHandlerContext channelHandlerContext,
          final Object message,
