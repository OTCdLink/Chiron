...
import com.otcdlink.chiron.fixture.tcp.AbstractTcpTransitServer;
...
public class ConnectProxy extends AbstractTcpTransitServer implements HttpProxy {
  ...
  public static ConnectProxy createAndStart(
    ...
    final ConnectProxy connectProxy = new ConnectProxy(
        listenAddress,
        eventLoopGroup == null ? EventLoopGroupOwner.EventLoopGroupFactory::defaultFactory : null,
        eventLoopGroup,
        watcher,
  ...
  public ConnectProxy(
    ...
    this(
        listenAddress,
        EventLoopGroupOwner.EventLoopGroupFactory::defaultFactory,
        null,
        watcher,
        PipelineConfigurator.Factory.NULL_FACTORY,
        1000
  ...
  public ConnectProxy(
      final InetSocketAddress listenAddress,
      final Function< String, EventLoopGroupOwner.EventLoopGroupFactory> eventLoopGroupFactorySupplier,
      final EventLoopGroup eventLoopGroup,
      final Watcher watcher,
      final PipelineConfigurator.Factory pipelineConfiguratorFactory,
      final int connectTimeoutMs
