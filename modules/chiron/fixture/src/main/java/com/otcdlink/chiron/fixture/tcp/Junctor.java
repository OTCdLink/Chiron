...
public abstract class Junctor {
  ...
  private Junction createJunction( final Logger logger, final Channel targetChannel ) {
    final TcpTransitTools.ForwardingRoute forwardingRoute = new TcpTransitTools.ForwardingRoute(
  ...
  protected final void configureJunction( final Channel targetChannel, final Junction junction ) {
    ...
    initiatorChannel.pipeline().addLast(
        TcpTransitTools.ChannelHandlerName.INITIATOR_STATE_SUPERVISION.handlerName(),
    ...
    if( TcpTransitTools.DUMP_PAYLOADS ) {
      TcpTransitTools.addLoggingHandlerFirst( initiatorChannel.pipeline(), TcpTransitTools.ChannelHandlerName.INITIATOR_SIDE_OUT.handlerName() ) ;
      TcpTransitTools.addLoggingHandlerLast( initiatorChannel.pipeline(), TcpTransitTools.ChannelHandlerName.INITIATOR_SIDE_IN.handlerName() ) ;
    }
    ...
    targetChannel.pipeline().addLast(
        TcpTransitTools.ChannelHandlerName.TARGET_STATE_SUPERVISION.handlerName(),
        new ChannelDuplexHandler() {
          @Override
    ...
    if( TcpTransitTools.DUMP_PAYLOADS ) {
      TcpTransitTools.addLoggingHandlerFirst( targetChannel.pipeline(), TcpTransitTools.ChannelHandlerName.TARGET_SIDE_IN.handlerName() ) ;
      TcpTransitTools.addLoggingHandlerLast( targetChannel.pipeline(), TcpTransitTools.ChannelHandlerName.TARGET_SIDE_OUT.handlerName() ) ;
    }
