...
import io.github.otcdlink.chiron.toolbox.netty.NettyHttpClient.Watcher;
...
public class NettyHttpClientTest {
  ...
  public void justGet(
      @Injectable final Watcher watcher
  ) throws Exception {
  ...
  @Test( timeout = TIMEOUT )
  public void httpsWithNoSslEngineFactory( @Injectable final Watcher watcher ) throws Exception {
    Thread.currentThread().setName( "JUnit" ) ;
  ...
  @Test( timeout = TIMEOUT )
  public void justPost( @Injectable final Watcher watcher ) throws Exception {
    Thread.currentThread().setName( "JUnit" ) ;
  ...
  @Test( timeout = TIMEOUT )
  public void timeout( @Injectable final Watcher watcher ) throws Exception {
    Thread.currentThread().setName( "JUnit" ) ;
  ...
  public void restart() throws Exception {
    ...
    final Watcher watcher = new Watcher() {
          ...
          public void complete(
            ...
            assertThat( Watcher.success( response.responseStatus.code() ) ).isTrue() ;
