...
public class IntradayFileChannelPersisterTest extends AbstractIntradayPersisterTest {
...
// =======
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger( IntradayFileChannelPersisterTest.class ) ;
  ...
  private final class PrivatePersisterKit extends PersisterKit {
    ...
    protected IntradayPersister< Designator, EchoUpwardDuty< Designator > > createPersister() {
      ...
      return new IntradayFileChannelPersister<>(
          file,
          bufferSize,
