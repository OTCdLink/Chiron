...
public abstract class AbstractIntradayPersisterTest {
  ...
  /**
   * Write enough {@link Command}s to saturate {@link IntradayFileChannelPersister}'s buffer, if we were
...
// =======
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger( AbstractIntradayPersisterTest.class ) ;
  ...
  protected abstract class PersisterKit {
    ...
    public final IntradayPersister< Designator, EchoUpwardDuty< Designator > >
        persister ;
    ...
    protected abstract IntradayPersister< Designator, EchoUpwardDuty< Designator > >
    createPersister() ;
