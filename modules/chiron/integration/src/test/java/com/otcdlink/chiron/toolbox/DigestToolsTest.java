...
// ======
  ...
  public void evaluateValidityPadding0() throws Exception {
    Assertions.assertThat( DigestTools.AbstractDigest.isValidBase64( "pleasure.".length(), "cGxlYXN1cmUu" ) ).isTrue() ;
  }

  @Test
  public void evaluateValidityPadding1() throws Exception {
    Assertions.assertThat( DigestTools.AbstractDigest.isValidBase64( "leasure.".length(), "bGVhc3VyZS4=" ) ).isTrue() ;
  }

  @Test
  public void evaluateValidityPadding2() throws Exception {
    Assertions.assertThat( DigestTools.AbstractDigest.isValidBase64( "easure.".length(), "ZWFzdXJlLg==" ) ).isTrue() ;
  }
