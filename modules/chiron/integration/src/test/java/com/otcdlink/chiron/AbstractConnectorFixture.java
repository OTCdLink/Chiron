...
import com.otcdlink.chiron.downend.DownendFixture.CommandTransceiverFixture;
...
import com.otcdlink.chiron.integration.echo.UpwardEchoCommandUntracked;
...
// ======================
  ...
  public final void checkDequeuedDownwardCommandEquivalentTo(
    ...
    final Command< ENDPOINT_SPECIFIC, EchoDownwardDuty< ENDPOINT_SPECIFIC > > actual =
        dequeueDownwardCommandReceived() ;
    if( actual.endpointSpecific instanceof Command.Tag ) {
...
// ========================
  ...
  public static final Command.Tag TAG_0 = new Command.Tag( TrackerCurator.TAG_PREFIX + "0" ) ;

  public static final Command.Tag TAG_1 = new Command.Tag( TrackerCurator.TAG_PREFIX + "1" ) ;
