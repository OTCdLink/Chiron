...
public class FileChunkerTest {
  ...
  /**
   * This test is more about investigating {@link Flux} behavior than testing {@link FileChunker}
   * itself.
   */
  @Test
...
// =======
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger( FileChunkerTest.class ) ;
