...
public final class StateUpdater {
  ...
  private static final ImmutableMap<
      DownendConnector.State,
      DownendConnector.Change<DownendConnector.State>
  > STATE_CHANGE_SINGLETONS =
      ImmutableMap.of(
          DownendConnector.State.STOPPED, new DownendConnector.Change<>( DownendConnector.State.STOPPED ),
          DownendConnector.State.CONNECTING, new DownendConnector.Change<>( DownendConnector.State.CONNECTING ),
          DownendConnector.State.SIGNED_IN, new DownendConnector.Change<>( DownendConnector.State.SIGNED_IN ),
          DownendConnector.State.STOPPING, new DownendConnector.Change<>( DownendConnector.State.STOPPING )
      )
  ;
  ...
  public Transition update( final Function< StateBody, StateBody > updater ) {
    ...
    DownendConnector.Change<DownendConnector.State> change ;
