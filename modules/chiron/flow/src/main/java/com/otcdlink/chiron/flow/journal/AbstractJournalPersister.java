 ...
 * {@link JournalFileReader} if {@link #schemaVersion}s are compatible.
 */
public abstract class AbstractJournalPersister< DESIGNATOR, DUTY, SINK extends Closeable >
    implements
    JournalPersister< Command< DESIGNATOR, DUTY > >,
    CommandConsumer< Command< DESIGNATOR, DUTY > >
{

  private static final Logger LOGGER = LoggerFactory.getLogger( AbstractJournalPersister.class ) ;
  ...
  protected AbstractJournalPersister(
