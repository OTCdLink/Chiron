...
/**
 * An {@code Exception} that may contains several {@code Exception}s.
 *
 * Other candidate names:
 * Manifold, Multi (used by Jetty), Tupling, Tupled, Tapling, Combo, Collecting, Gathering
 */
public class MultiplexingException extends Exception {

  public final ImmutableList< Throwable > exceptions ;

  public MultiplexingException( final String message, final ImmutableList< Throwable > exceptions ) {
  ...
  public static Collector< MultiplexingException > newCollector() {
    return new Collector<>( MultiplexingException::new ) ;
  }
  ...
  public static final class Collector< E extends MultiplexingException> {
