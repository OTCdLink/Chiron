...
import io.github.otcdlink.chiron.toolbox.internet.InternetAddressValidator;
...
import static io.github.otcdlink.chiron.toolbox.ComparatorTools.STRING_COMPARATOR;
  ...
  public static final Comparator< KeystoreAccess > COMPARATOR
      = new ComparatorTools.WithNull< KeystoreAccess >() {
        ...
        protected int compareNoNulls(
          ...
          final int aliasComparison = STRING_COMPARATOR.compare( first.alias, second.alias ) ;
          if( aliasComparison == 0 ) {
            final int passwordComparison
                = STRING_COMPARATOR.compare( first.password, second.password ) ;
            if( passwordComparison == 0 ) {
              final int urlComparison = STRING_COMPARATOR.compare(
